...
test('Test TZ=EST workaround', () => {
  // This works, but I don't know how one would handle daylight saving time this way; probably best to stick with UTC
  expect(new Date('2028-11-05T00:00:00.000-05:00').toISOString()).toEqual(
    '2028-11-05T05:00:00.000Z'
  );
});
